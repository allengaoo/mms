...
| 族                    | 内置类型（节选）                                                            | 执行顺序 |
| -------------------- | ------------------------------------------------------------------- | ---- |
| **A Schema**         | `SCHEMA_ADD_FIELD` · `SCHEMA_MODIFY_FIELD` · `CONTRACT_ADD_REQUEST` | 1    |
| **C Data Access**    | `QUERY_ADD_SELECT` · `MUTATION_ADD_INSERT` · `MUTATION_ADD_UPDATE`  | 2    |
| **B Control Flow**   | `LOGIC_ADD_CONDITION` · `LOGIC_ADD_BRANCH` · `LOGIC_EXTRACT_METHOD` | 3    |
| **E Infrastructure** | `EVENT_ADD_PRODUCER` · `EVENT_ADD_CONSUMER` · `CACHE_ADD_READ`      | 3    |
| **D Interface**      | `ROUTE_ADD_ENDPOINT` · `ROUTE_ADD_PERMISSION` · `FRONTEND_ADD_PAGE` | 4–5  |
