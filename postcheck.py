...
def _ast_sync_check(ep_norm: str, scope_files: List[str]) -> Dict:
    ...
    try:
        ...
        from ontology_syncer import sync_after_unit_run  # type: ignore[import]
...
def run_postcheck(
    ...
    try:
        from mms.precheck import load_checkpoint
    except ImportError:
        from precheck import load_checkpoint  # type: ignore[no-redef]
