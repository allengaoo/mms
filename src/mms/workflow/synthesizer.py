...
try:
    ...
    from mms.utils.mms_config import cfg as _mms_cfg  # type: ignore[import]
except Exception:
...
def synthesize(
    ...
    try:
        try:
            ...
            from mms.memory.intent_classifier import IntentClassifier  # type: ignore[no-redef]
            from mms.analysis.arch_resolver import ArchResolver           # type: ignore[no-redef]
